        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Repository = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderIndex = table.Column<int>(type: "INTEGER", nullable: false),
                    DependsOnPhaseIds = table.Column<string>(type: "TEXT", nullable: true),
                    StartedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    CompletedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: false)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Phases_Milestones_MilestoneId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Type = table.Column<int>(type: "INTEGER", nullable: false),
                    Source = table.Column<int>(type: "INTEGER", nullable: false),
                    OrderInColumn = table.Column<int>(type: "INTEGER", nullable: false),
                    ...
                    ConversationRef = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Phases_MilestoneId",
                table: "Phases",
                column: "MilestoneId");

            migrationBuilder.CreateIndex(
                name: "IX_Phases_Status",
                table: "Phases",
                column: "Status");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tasks_Status_OrderInColumn",
                table: "Tasks",
                columns: new[] { "Status", "OrderInColumn" });
